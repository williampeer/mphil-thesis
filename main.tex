...
\section{Other key works}\ref{sect:key_works}
...
Description of main results of the rest of the thesis,

and a list of main contributions made by the thesis
\begin{itemize}
    \item Main 1
    \item Main 2
\end{itemize}
...
\chapter{Complementary poster: Izhikevich recovery variable parameters, oscillations and resulting network rates}
