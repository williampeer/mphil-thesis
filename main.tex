...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{figures/matlab/NMF_geodesic_all_minus_microGIF_NLL_B.eps}
    \caption{all NMF distances. some fits for SGIF not included (currently running)}
\end{figure}
