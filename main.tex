...
It has been used in previous published studies, in which evaluation and assessment through rigorous analysis and classification and prediction of the future brain state given the neuronal signals, as well as NMF modules, was performed \cite{Tsunematsu2019}. 

We here replicate results of \cite{Tsunematsu2019}, showing that NMF ACs were more indicative of future brain state than HPC signals, which was a novel finding when presented in the original work.
...
When tested, we find that single-neuron signals were slightly better predictors. 
However, as the gain was only small it also suggests that the ensembles were very good representations of functional units, as argued in the original paper.
