...
Works such as \cite{Jin2018} employ a rate-based error metric for readouts pertaining to image classification tasks, whereas work such as \cite{Wu2018} employ a population code and rate based combination.
